...
- [4300-Flask-Template-JSON](#4300-flask-template-json)
  - [Contents](#contents)
  - [Summary](#summary)
  ...
  - [Running locally](#running-locally)
    ...
    - [Step 3: Modify init.json file](#step-3-modify-initjson-file)
  - [Command to run project locally:](#command-to-run-project-locally)
